    ...
    fun getCats(): List<CatItem> {
        return listOf(
            ...
            CatItem(
                ...
                imageUrl = "https://cataas.com/cat/says/Hola?width=600&height=600",
                tags = listOf("text")
            ),
            ...
            CatItem(
                ...
                imageUrl = "https://cataas.com/cat/says/Bon%20dia?width=600&height=600",
                tags = listOf("text")
            ),
            ...
            CatItem(
                ...
                imageUrl = "https://cataas.com/cat/says/Cute%20cat?width=600&height=600",
                tags = listOf("text")
            ),
            ...
            CatItem(
                ...
                imageUrl = "https://cataas.com/cat/says/Hello!%20%F0%9F%90%B1?width=600&height=600",
                tags = listOf("text")
            )
        )
    }
